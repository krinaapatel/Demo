      ...
      <div class="col-9  text-right">
        ...
        <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
          <ul class="site-menu main-menu js-clone-nav ml-auto ">
            <li class="active"><a href="<?php echo e(url('services')); ?>" class="nav-link">Book Appoitment</a></li>
...
<div class="container">
  <div class="row justify-content-center text-center">
    <div class="col-7 text-center mb-5">
	  ...
	  <form method="post" action="<?php echo e(action('AppointmentController@store')); ?>" enctype='multipart/form-data'>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="text" name="contact" required class="form-control" style="width:100%;" >
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="date" required name="date" class="form-control" style="width:100%;" >
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="text" required name="services" class="form-control" style="width:100%;" >
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="text" required name="price" class="form-control" style="width:100%;" >
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="text" required name="discount" class="form-control" style="width:100%;" >
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="text" required name="totalPrice" class="form-control" style="width:100%;" >
